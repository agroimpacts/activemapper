...
- The impact of training data error on map quality:
  ...
  - Although these differences were assessed against the validation sites, which were themselves consensus labels, there are real differences in quality that can be seen in the resulting probability images, where probabilities from the model trained with the least accurate worker's labels are clearly less certain (Figure S6).
