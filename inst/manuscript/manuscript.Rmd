...
A second measure of the impact of training data error can be obtained by calculating the Spearman Rank Correlation coefficient between the average label risk per AOI versus various model performance metrics.  
