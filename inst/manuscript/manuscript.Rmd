...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
data("label_summary")  
tsites <- label_summary$nlabels %>% group_by(kml_type) %>% 
...
After each site was mapped by four labellers, consensus labels were generated. 
