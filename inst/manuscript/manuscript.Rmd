...
In the final step, the retained polygons are refined by removing holes and smoothing their boundaries using the Visvalingam algorithm [@VisvalingamLineGeneralisation1993]. Neighboring polygon that touch along tile boundaries are merged.
...
We present here a method for developing high resolution maps that detail the characteristics of smallholder-dominated croplands, providing information on their geometries and distribution of <5 m resolution, and representing a single agricultural year. 
...
Improvements:    
- Replace Random Forest with deep learning model. Can still retain the active architecture, but instead use new sites to improve a pre-trained model
