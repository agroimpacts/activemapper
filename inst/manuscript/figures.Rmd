...
# entire cropland fraction
cropfrac <- stars::read_stars(
  system.file("extdata/probs_005.tif", package = "activemapper")
)
...
p <- ggplot(africa) + 
  ...
  coord_sf(xlim = maprange[1:2], ylim = maprange[3:4]) + 
  theme_void() + 
  theme(legend.position = c(0.65, 0.07), legend.direction = "horizontal", 
