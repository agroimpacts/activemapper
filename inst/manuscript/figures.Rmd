...
aois <- c(paste0("labeller", 1:16), "All")
...
### Figure 6: Categorical map accuracy
...
### Figure S6: Consensus label (Bayesian) risk
...
### Figure S8: Segmentation statistics
...
p <- ggplot(humachine) + 
  ...
  theme_fun()
ggsave(pth("figures/si_validation_stats_fha.png"), 
...
p2 <- ggplot(humachine) + 
  ...
  theme_fun()
ggsave(pth("figures/si_validation_stats_fn.png"), 
       width = 7, height = 7, units = "in", dpi = 300)
