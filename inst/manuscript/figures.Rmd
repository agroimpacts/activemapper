...
### Figure S7: Label count and quality
...
### Figures S8 and S9: Consensus label (Bayesian) risk
...
### Figure S10: Random versus active sampling
```{r, eval=FALSE}
data("iteration_metrics")
...
### Figure S11: Training data error impact on probability images
```{r, eval = FALSE}
