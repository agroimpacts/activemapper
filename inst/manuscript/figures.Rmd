...
# gp <- t1 + m
ggsave(t1, filename = pth("figures/figure7.png"), width = 7, height = 7.9, 
       units = "in", dpi = 300)
```
...
ggsave(filename = pth("figures/figure8.png"), 
...
### Figure S11: Segmentation statistics (grid scale)
