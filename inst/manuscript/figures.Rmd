...
### Figure S3: PlanetScope image density
...
### Figures S6 and S7: Consensus label (Bayesian) risk
...
### Figure S9: Training data error impact on probability images
```{r, eval = FALSE}
...
### Figures S11 and S12: Segmentation statistics (grid scale)
...
### Figure S13: Average fields sizes
