...
### Figure S3: Map reference sample
```{r, eval = FALSE}
...
p <- ggplot(africa) + 
  ...
  coord_sf(xlim = maprange[1:2], ylim = maprange[3:4]) + 
  theme_void() + 
  theme(legend.position = c(0.64, 0.08), legend.direction = "horizontal", 
...
### Figure S5: PlanetScope image density
...
### Figure S6: Initial training site distribution
...
### Figure S8: Random versus active sampling
```{r, eval=FALSE}
data("iteration_metrics")
...
### Figures S10 and S11: Consensus label (Bayesian) risk
...
### Figure S12: Training data error impact on probability images
```{r, eval = FALSE}
...
### Figures S13 and S14: Segmentation statistics (grid scale)
...
### Figure S15: Average fields sizes
