...
The pre-preparation of base datasets that install with the `activemapper` package is shown in `data-raw/data_for_instances.R`. These are loaded in here from `ext_data`.
