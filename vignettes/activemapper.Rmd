...
+ `fboundary_stats_valsites.R`: Extract digitized and segmented field boundary stats from validation sites
    - `inst/extdata/field_validation_stats.rda`
+ `intersect_segments_with_reference.R`: Intersect reference labels with segmented field boundaries. 
...
+ `label_v_segments_summarize.R`: Comparison of areas and counts of fields in the hand-digitized labels versus the machine-segmented fields at the grid, tile, and AOI scales
    - `activemapper::segment_quality_stats`
